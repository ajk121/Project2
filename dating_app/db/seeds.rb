...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  User.create(email: "paul@gmail.com", password: "password", password_confirmation: "password", name: "Paul Gracey", age: "32", gender: "Male", city: "London", sex_preference: "Female", meet_ups: "LRUG", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP ",stackoverflow_score: "552", height: "173", github_id: "paul.php", about_me: "Drop me a line of code to find out" )
  ...
  User.create(email: "donny@gmail.com", password: "password", password_confirmation: "password", name: "Donny Brasco", age: "43", gender: "Male", city: "NY & London", sex_preference: "Female", meet_ups: "LRUG, MRUG, forgayze.js, Tech Arts", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP,  ",stackoverflow_score: "390", height: "187", github_id: "forgayze.tech", about_me: "I turn code into £££, all things lavish" )

  User.create(email: "bobby@gmail.com", password: "password", password_confirmation: "password", name: "Bobby Va Va Voom", age: "39", gender: "Male", city: "NY & London & Paris", sex_preference: "Female", meet_ups: "LRUG, MRUG, Voom Tech, Start_ups.Paree Tech Arts", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP, ",stackoverflow_score: "390", height: "175", github_id: "vavavoom", about_me: "Hey bobby whats french for has_many :money" )

  User.create(email: "jackie@gmail.com", password: "password", password_confirmation: "password", name: "Jackie Chan", age: "33", gender: "Male", city: "NY & London", sex_preference: "Female", meet_ups: "NY Tech, Start_ups.Paree, Tech Arts", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP, ",stackoverflow_score: "550", height: "180", github_id: "onemorething", about_me: "function(){?} " )

  User.create(email: "mickey@gmail.com", password: "password", password_confirmation: "password", name: "Mickey", age: "39", gender: "Male", city: "London & NY", sex_preference: "Female", meet_ups: "MRUG, Voom Tech,  Start_ups.Paree Tech Arts", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP, ",stackoverflow_score: "450", height: "186", github_id: "vavavoom", about_me: "I build Daags" )

  User.create(email: "lisa@gmail.com", password: "password", password_confirmation: "password", name: "Lisa Smith", age: "39", gender: "Female", city: "London & NY", sex_preference: "Male", meet_ups: "MRUG, Voom Tech,  Start_ups.Paree Tech Arts", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, PHP, ",stackoverflow_score: "450", height: "155", github_id: "lisa.20", about_me: "Tech Super Women" ) 
  ...
  User.create(email: "francesca@gmail.com", password: "password", password_confirmation: "password", name: "Francesca Rodriguez", age: "33", gender: "Female", city: "London & Munich & Madrid", sex_preference: "Male", meet_ups: "Codebar, LRUG, MadridRUG", front_backend:"Front & Backend",favourite_language: "Rails, Javascript, Ruby",stackoverflow_score: "302", height: "174", github_id: "fran.sp", about_me: "I hack anything & everyone" ) 
