...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  User.create(email: "amanda@gmail.com", password: "password", password_confirmation: "password", name: "Amanda Piers", age: "29", gender: "Female", city: "London", sex_preference: "Male", meet_ups: "NY Tech Stars", front_backend:"Front-End",favourite_language: "Ruby",stackoverflow_score: "40", height: "172", github_id: "amanda.p", about_me: "Can you keep up?", smoker: "No" ) 

  User.create(email: "laura@gmail.com", password: "password", password_confirmation: "password", name: "Laura Andrews", age: "39", gender: "Female", city: "London", sex_preference: "Male", meet_ups: "Codebar ", front_backend:"Back-End",favourite_language: "Ruby",stackoverflow_score: "490", height: "168", github_id: "laura.and.tech", about_me: "Unbeatable Tech Guru", smoker: "No" ) 

  User.create(email: "samantha@gmail.com", password: "password", password_confirmation: "password", name: "Samantha Stuart", age: "27", gender: "Female", city: "New York", sex_preference: "Male", meet_ups: "Tech Arts", front_backend:"Front-End",favourite_language: "Javascript",stackoverflow_score: "106", height: "164", github_id: "sam.stuart", about_me: "looking for my tech superhero", smoker: "No" ) 
  ...
  User.create(email: "Elizabeth@gmail.com", password: "password", password_confirmation: "password", name: "Elizabeth Bennet", age: "35", gender: "Female", city: "Paris", sex_preference: "Male", meet_ups: "Tech Arts", front_backend:"Back-End",favourite_language: "Ruby",stackoverflow_score: "800", height: "179", github_id: "bennet.e", about_me: "The modern day tech Picasso ", smoker: "No" ) 

  User.create(email: "stephanie@gmail.com", password: "password", password_confirmation: "password", name: "Stephanie Jacobs", age: "25", gender: "Female", city: "Madrid", sex_preference: "Male", meet_ups: "LRUG", front_backend:"Back-End",favourite_language: "Ruby",stackoverflow_score: "150", height: "170", github_id: "stephanie.js", about_me: "Tech girly girl", smoker: "No" ) 

  User.create(email: "Kate.a@gmail.com", password: "password", password_confirmation: "password", name: "Katie Andrews", age: "29", gender: "Female", city: " Madrid", sex_preference: "Male", meet_ups: "Codebar", front_backend:"Back-End",favourite_language: "Ruby",stackoverflow_score: "150", height: "170", github_id: "stephanie.js", about_me: "Tech girly girl", smoker: "No" ) 

  User.create(email: "andrea@gmail.com", password: "password", password_confirmation: "password", name: "Andrea Smith", age: "29", gender: "Female", city: "Paris", sex_preference: "Male", meet_ups: "MUNICHRUG", front_backend:"Front-End",favourite_language: "Javascript",stackoverflow_score: "150", height: "170", github_id: "stephanie.js", about_me: "Tech girly girl", smoker: "No" ) 

  User.create(email: "francesca@gmail.com", password: "password", password_confirmation: "password", name: "Francesca Rodriguez", age: "33", gender: "Female", city: "London", sex_preference: "Male", meet_ups: "MadridRUG", front_backend:"Back-End",favourite_language: "Ruby",stackoverflow_score: "302", height: "174", github_id: "fran.sp", about_me: "I hack anything & everyone", smoker: "No" ) 
